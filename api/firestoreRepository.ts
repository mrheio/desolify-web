...
export const usersRepository = createFirestoreRepository<AppUser>(
    'users',
    createUser
);

export const gamesRepository = createFirestoreRepository<Game>(
    'games',
    createGame
);

export const teamsRepository = createFirestoreRepository<Team>(
    'teams',
    createTeam
);
